...
// Defining the Spotify authorization URL with necessary parameters 
// client ID, response type, redirect URI, and scope.
const AUTH_URL =
...
const SpotifyAPI = () => {
  return (
    <StarryNight>
      {/* custom component (StarryNight) as the background for the login page. */}
